                ...
                <div class="form-row">
                    <div class="col-md-4 mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input name="preco" value="<?php echo $ordem_servico[0]->preco ?>" type="text" class="form-control" required>    
                        </div>
                        <div class="invalid-feedback">
                            Forneça um valor válido.
                        </div>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <select name="forma_pagamento" class="custom-select">
                            <option selected  value="<?php echo $ordem_servico[0]->forma_pagamento ?>"><?php echo $ordem_servico[0]->forma_pagamento ?></option>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input name="desconto" value="<?php echo $ordem_servico[0]->desconto ?>" type="text" class="form-control">
                        </div>
                        <div class="invalid-feedback">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="status" class="custom-select" required>
                            <option selected  value="<?php echo $ordem_servico[0]->status ?>"> <?php echo $ordem_servico[0]->status ?></option>
