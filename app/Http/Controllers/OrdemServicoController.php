...
class OrdemServicoController extends Controller
{
    ...
    public function enviaEmail(Request $request, OrdemServicoRepositoryInterface $ordem_servico_repository)
    {
        ...
        Mail::to($resultado['cliente'][0]->email)->send(new ordemServicoMail($resultado['cliente'][0], $resultado['aparelho'][0], $resultado['os_aparelho'][0], $resultado['os_peca'][0], $resultado['tecnico'][0], $resultado['os_tecnico'][0], $resultado['atendente'][0], $resultado['ordem_servico'][0]));
